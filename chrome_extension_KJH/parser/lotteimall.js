...
function createProduct() {
  var cats = document.querySelectorAll("a.one");
  var product = {
    shop: "LotteIMall",
    name: document.querySelector("title").textContent.trim(),
    price: document.querySelector("strong.final").textContent.trim(),
    imgSrc: document.querySelector("div.thumb_product img").src,
    category: cats[cats.length-1].textContent.trim(),
    url: document.URL,
  };
  return product;
}
