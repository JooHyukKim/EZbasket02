...
/*  var cats = document.querySelector("div.loc").querySelectorAll("a.dropdown");
  ...
  var product = {
    shop: "LookPin",
    name: document.getElementsByClassName("ProductDetailDesktop_title__3AQr4")[0].innerHTML,
    price: document.querySelector(".ProductDetailDesktop_price__7vSoT").innerHTML,
    imgSrc: document.querySelector("picture").getElementsByTagName("img")[0]
      .src,
    category: null,
    url: document.URL,
  };
