...
function createProduct() {
  ...
  var product = {
    shop: "LotteOn",
    name: document.querySelector("div.productName h1").textContent.trim(),
    price: document.querySelector("div.price span").textContent.trim(),
    imgSrc: document.querySelector("div.imgWrap img").src,
