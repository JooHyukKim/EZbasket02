console.log("컨텐트 스크립트 시작");chrome.storage.sync.get(["productList"], function (items) {  var productList = new Array();
  if (items.productList == null) {    console.log("No Items in List");
  } else {    productList = items.productList;
    console.log("Item exists");
    console.log(productList);
  }  if (document.querySelector("title") != null) {
    try {      var item = createProduct();
    } catch (error) {      swal({
        position: 'top-end',
        icon: 'error',
        title: '상품을 찾을수 없습니다..',
    ...
    console.log("item not found");    swal({      position: 'top-end',
      icon: 'error',
      title: '실패하였습니다.',
      showConfirmButton: false,
      timer: 1000
...
function createProduct() {
  var cats = document
    .querySelector("ul.location")
    .querySelectorAll("div.selBtn01 span");
  var categor = "";
  cats.forEach((cat) => {
